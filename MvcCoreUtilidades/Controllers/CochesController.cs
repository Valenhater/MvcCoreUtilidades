...
namespace MvcCoreUtilidades.Controllers
{
    public class CochesController : Controller
    {
        ...
        //AQUI SOLAMENTE MOSTRAMOS LA LISTA INDEX
        public IActionResult Index()
        {

            return View();
        }
        //NECESITAMOS UNA PETICION IACTIONRESULT QUE CARGARA LOS COCHES, DICHA PETICION IRA INTEGRADA DENTRO DE OTRA VISTA(INDEX)
        public IActionResult _CochesPartial()
        {
            //SI VAMOS A UTILZAR UNA VISTA PARCIAL CON AJAX DEBEMOS DEVOLVER PartialView()
